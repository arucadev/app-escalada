...
public class CrearVia {
    ...
    private void insertarVia(int idVia, String nom, String orientacio, String estat, String ancoratges,
    ...
    private void insertarViaEsportiva(int idViaEsportiva, int idVia, String ancoratgesPermesos,
    ...
    private void insertarViaClassica(int idViaClassica, int idVia, String ancoratgesPermesos,
                                   String grauDificultat, int llargadaTotal) throws SQLException {
    ...
    private void insertarViaGel(int idViaGel, int idVia, String ancoratgesPermesos,
                              String grauDificultat, int llargadaTotal) throws SQLException {
    ...
    public void crearTramsClassica(int idViaClassica) {
        try {
    ...
    public void crearTramsGel(int idViaGel) {
        try {
            System.out.println("\n=== CREAR TRAMS VIA GEL ===");
            System.out.print("Quants trams té la via? ");
            int numTrams = Integer.parseInt(scanner.nextLine());
    ...
    private void insertarTramClassica(int idTram, int idViaClassica, double llargada,
    ...
    private void insertarTramGel(int idTram, int idViaGel, double llargada,
                               String grauDificultat, int numTram) throws SQLException {
