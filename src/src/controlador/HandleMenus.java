...
import controlador.objectes.vies.CrearVia;
import controlador.objectes.vies.EliminarVia;
import controlador.objectes.vies.LlistarVia;
import controlador.objectes.vies.ModificarVia;
...
public class HandleMenus {
    ...
    public static void main(String[] args) {
        try (Connection connection = DriverManager.getConnection("jdbc:sqlite:db/vies_db1.db"); Scanner scan = new Scanner(System.in)) {
        ...
        do {
            ...
            switch (option) {
                case 1:
                    ...
                    handleModificarVia(vista, scan, connection);
                    break;
                case 2:
    ...
    private static void handleModificarVia(Vista vista, Scanner scan, Connection connection) {
        ModificarVia modificarVia = new ModificarVia(connection, scan);
    ...
    private static void handleMenuLlistar(Vista vista, Scanner scan, SQLiteEscolaDAO escolaDAO, SQLiteSectorDAO sectorDAO, SQLiteEscaladorDAO escaladorDAO, SQLiteViaDAO viaDAO, Connection connection) {
        ...
        do {
            ...
            switch (option) {
                case 1:
                    handleSubMenuLlistarVies(vista, scan, connection);
                    break;
                case 2:
    ...
    private static void handleSubMenuLlistarVies(Vista vista, Scanner scan, Connection connection) {
        // Create an instance of LlistarVia with the connection
        LlistarVia llistarVia = new LlistarVia(connection, scan);
        ...
        do {
            ...
            switch (option) {
                case 1:
                    ...
                    handleEliminarVia(vista, scan, connection);
                    break;
                case 2:
    ...
    private static void handleEliminarVia(Vista vista, Scanner scan, Connection connection) {
        // Create an instance of EliminarVia
        EliminarVia eliminarVia = new EliminarVia(connection, scan);
